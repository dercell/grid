...
double int_average(int* mass, long int n, short int flag)
{
	long int i;
...
int main(int argc, char *argv[]){
	...
	int c_clusters[100000], d_clusters[15000],  k=0, c=0;
	long int m=0,l=0, i=0, j=0;
	...
	mrg32k3a_init_sequence_(&state_1, 125);
	...
	T=1.799999;
		...
		{	
			...
			int_average(c_clusters, 100000, 1);
		}
	...
	//int_average(c_clusters, 500000, 1);
	free(LL);
	free(perc_arr);
	return 0;
}
